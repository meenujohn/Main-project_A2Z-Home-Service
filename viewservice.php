...
if($login)
{
    ...
    <?php 
    include 'co.php';
    //$se= "select sid,service,description from addservice order by sid desc";
...
<br>
    <form action="searchservice.php" method="post">
        ...
        <input type="text" name="keyword" size="20" placeholder="Search for Service...." required="" style="width: 40%;height: 35px;" autocomplete="off" />
...
// Getting total number of pages
        ...
        $sql = "SELECT * FROM addservice  order by sid desc LIMIT $offset, $no_of_records_per_page";
